  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <div className="absolute -top-40 right-[-12%] h-[520px] w-[520px] rounded-full bg-accent/20 blur-[140px]" />
        <div className="absolute bottom-[-25%] left-[-15%] h-[460px] w-[460px] rounded-full bg-accent/10 blur-[160px]" />
